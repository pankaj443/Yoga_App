...
public class workoutFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        workoutsList.add(new workout(1,R.drawable.wo_bg_1,getActivity().getString(R.string.b1),"8 Minutes",getActivity().getString(R.string.n1),"10 Excercises",getContext().getResources().getDrawable(R.drawable.morning)));
        ...
        workoutsList.add(new workout(1,R.drawable.wo_bg_1,getActivity().getString(R.string.b5),"10 Minutes",getActivity().getString(R.string.n5),"12 Excercises",getContext().getResources().getDrawable(R.drawable.sun)));
        ...
        workoutsList.add(new workout(1,R.drawable.wo_bg_1,getActivity().getString(R.string.b8),"7 Minutes",getActivity().getString(R.string.n8),"8 Excercises",getContext().getResources().getDrawable(R.drawable.twist)));
        workoutsList.add(new workout(1,R.drawable.wo_bg_1,getActivity().getString(R.string.b9),"14 Minutes",getActivity().getString(R.string.n9),"14 Excercises",getContext().getResources().getDrawable(R.drawable.back)));
